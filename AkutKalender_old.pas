...
type
  ...
  private
    ...
    // Avsedd som en lokal array för sparandet av dagens och morgondagens data
    // skall spara på antalet läsningar i databasen, om jag tänkt rätt ;-)
    // NS 2011-05-10
...
{$IFDEF utv}
  CurrDay := StrToDate('2011-09-15'); // Ska ersättas med dagens datum
{$ENDIF}
  imorgon := TRUE;
